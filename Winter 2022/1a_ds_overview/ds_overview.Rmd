...
-   `r fontawesome::fa("r-project", fill = "black")` &rarr; RStudio
-   `r fontawesome::fa("python", fill = "black")` &rarr; PyCharm, Jupyter, RStudio
-   SQL &rarr; MySQL Workbench, Oracle SQL Developer, RStudio
