...
Now let's give the 1's and 2's of `party` more informative labels. To do this in R, we'll convert this variable to a categorical variable with the `factor` function. 
...
leg.data <- 
  leg.data %>%
  mutate(XMP098 = ifelse(XMP098 == -6, NA, XMP098))
```
